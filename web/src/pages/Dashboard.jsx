...
export default function Dashboard() {
  ...
  const [jiraConnected, setJiraConnected] = useState(false) // <--- New State
  const bottomRef = useRef(null)

  // 1. Boot: Check Session, Load Project, and Check Jira Status
  useEffect(() => {
    const boot = async () => {
  ...
  // Function to trigger Jira OAuth flow
        ...
        <div className="sidebar-content">
          ...
          <div className="info-card" style={{ padding: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              {!jiraConnected && (
                <button onClick={handleConnectJira} className="btn btn-outline" style={{ padding: '4px 8px', fontSize: '0.7rem' }}>
                  Connect
                </button>
              )}
            </div>
